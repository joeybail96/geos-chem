...
! RCONST(735) = constant rate coefficient
  ...
  RCONST(795) = (OHuptkBySALACl(State_Het))
  RCONST(796) = (OHuptkBySALCCl(State_Het))
  RCONST(797) = (BrNO3uptkByH2O(State_Het))
  RCONST(798) = (BrNO3uptkByHCl(State_Het))
  RCONST(799) = (ClNO3uptkByH2O(State_Het))
  RCONST(800) = (ClNO3uptkByHCl(State_Het))
  RCONST(801) = (ClNO3uptkByHBr(State_Het))
  RCONST(802) = (ClNO3uptkByBrSALA(State_Het))
  RCONST(803) = (ClNO3uptkByBrSALC(State_Het))
  RCONST(804) = (ClNO3uptkBySALACL(State_Het))
  RCONST(805) = (ClNO3uptkBySALCCL(State_Het))
  RCONST(806) = (ClNO2uptkBySALACL(State_Het))
  RCONST(807) = (ClNO2uptkBySALCCL(State_Het))
  RCONST(808) = (ClNO2uptkByHCl(State_Het))
  RCONST(809) = (ClNO2uptkByBrSALA(State_Het))
  RCONST(810) = (ClNO2uptkByBrSALC(State_Het))
  RCONST(811) = (ClNO2uptkByHBr(State_Het))
  RCONST(812) = (HOClUptkByHCl(State_Het))
  RCONST(813) = (HOClUptkByHBr(State_Het))
  RCONST(814) = (HOClUptkBySALACL(State_Het))
  RCONST(815) = (HOClUptkBySALCCL(State_Het))
  RCONST(816) = (HOClUptkByHSO3m(State_Het)+HOClUptkBySO3mm(State_Het)+SRHOCl)
  RCONST(817) = (HOBrUptkByHBr(State_Het))
  RCONST(818) = (HOBrUptkByHCl(State_Het))
  RCONST(819) = (HOBrUptkBySALACL(State_Het))
  RCONST(820) = (HOBrUptkBySALCCL(State_Het))
  RCONST(821) = (HOBrUptkByBrSALA(State_Het))
  RCONST(822) = (HOBrUptkByBrSALC(State_Het))
  RCONST(823) = (HOBrUptkByHSO3m(State_Het)+HOBrUptkBySO3mm(State_Het)+SRHOBr)
  RCONST(824) = (O3uptkByHBr(State_Het))
  RCONST(825) = (O3uptkByBrSALA(State_Het))
  RCONST(826) = (O3uptkByBrSALC(State_Het))
  RCONST(827) = (HBrUptkBySALA(State_Het))
  RCONST(828) = (HBrUptkBySALC(State_Het))
  RCONST(829) = (IuptkBySulf1stOrd(SR_MW(ind_HI),0.10_dp,State_Het))
  RCONST(830) = (IuptkBySALA1stOrd(SR_MW(ind_HI),0.10_dp,State_Het))
  RCONST(831) = (IuptkBySALC1stOrd(SR_MW(ind_HI),0.10_dp,State_Het))
  RCONST(832) = (IuptkByAlkSALA1stOrd(SR_MW(ind_HOI),0.01_dp,State_Het))
  RCONST(833) = (IuptkByAlkSALC1stOrd(SR_MW(ind_HOI),0.01_dp,State_Het))
  RCONST(834) = (IuptkBySulf1stOrd(SR_MW(ind_I2O2),0.02_dp,State_Het))
  RCONST(835) = (IuptkBySALA1stOrd(SR_MW(ind_I2O2),0.02_dp,State_Het))
  RCONST(836) = (IuptkBySALC1stOrd(SR_MW(ind_I2O2),0.02_dp,State_Het))
  RCONST(837) = (IuptkBySulf1stOrd(SR_MW(ind_I2O3),0.02_dp,State_Het))
  RCONST(838) = (IuptkBySALA1stOrd(SR_MW(ind_I2O3),0.02_dp,State_Het))
  RCONST(839) = (IuptkBySALC1stOrd(SR_MW(ind_I2O3),0.02_dp,State_Het))
  RCONST(840) = (IuptkBySulf1stOrd(SR_MW(ind_I2O4),0.02_dp,State_Het))
  RCONST(841) = (IuptkBySALA1stOrd(SR_MW(ind_I2O4),0.02_dp,State_Het))
  RCONST(842) = (IuptkBySALC1stOrd(SR_MW(ind_I2O4),0.02_dp,State_Het))
  RCONST(843) = (IuptkByAlkSALA1stOrd(SR_MW(ind_IONO),0.02_dp,State_Het))
  RCONST(844) = (IuptkByAlkSALC1stOrd(SR_MW(ind_IONO),0.02_dp,State_Het))
  RCONST(845) = (IuptkByAlkSALA1stOrd(SR_MW(ind_IONO2),0.01_dp,State_Het))
  RCONST(846) = (IuptkByAlkSALC1stOrd(SR_MW(ind_IONO2),0.01_dp,State_Het))
  RCONST(847) = (IONO2uptkByH2O(State_Het))
  RCONST(848) = (IbrkdnByAcidBrSALA(SR_MW(ind_IONO),C(ind_IONO),0.02_dp,State_Het))
  RCONST(849) = (IbrkdnByAcidBrSALC(SR_MW(ind_IONO),C(ind_IONO),0.02_dp,State_Het))
  RCONST(850) = (IbrkdnByAcidSALACl(SR_MW(ind_IONO),C(ind_IONO),0.02_dp,State_Het))
  RCONST(851) = (IbrkdnByAcidSALCCl(SR_MW(ind_IONO),C(ind_IONO),0.02_dp,State_Het))
  RCONST(852) = (IbrkdnByAcidBrSALA(SR_MW(ind_IONO2),C(ind_IONO2),0.01_dp,State_Het))
  RCONST(853) = (IbrkdnByAcidBrSALC(SR_MW(ind_IONO2),C(ind_IONO2),0.01_dp,State_Het))
  RCONST(854) = (IbrkdnByAcidSALACl(SR_MW(ind_IONO2),C(ind_IONO2),0.01_dp,State_Het))
  RCONST(855) = (IbrkdnByAcidSALCCl(SR_MW(ind_IONO2),C(ind_IONO2),0.01_dp,State_Het))
  RCONST(856) = (IbrkdnByAcidBrSALA(SR_MW(ind_HOI),C(ind_HOI),0.01_dp,State_Het))
  RCONST(857) = (IbrkdnByAcidBrSALC(SR_MW(ind_HOI),C(ind_HOI),0.01_dp,State_Het))
  RCONST(858) = (IbrkdnByAcidSALACl(SR_MW(ind_HOI),C(ind_HOI),0.01_dp,State_Het))
  RCONST(859) = (IbrkdnByAcidSALCCl(SR_MW(ind_HOI),C(ind_HOI),0.01_dp,State_Het))
  RCONST(860) = (GLYXuptk1stOrd(SR_MW(ind_GLYX),State_Het))
  RCONST(861) = (MGLYuptk1stOrd(SR_MW(ind_MGLY),State_Het))
  RCONST(862) = (IEPOXuptk1stOrd(SR_MW(ind_IEPOXA),.FALSE.,State_Het))
  RCONST(863) = (IEPOXuptk1stOrd(SR_MW(ind_IEPOXB),.FALSE.,State_Het))
  RCONST(864) = (IEPOXuptk1stOrd(SR_MW(ind_IEPOXD),.FALSE.,State_Het))
  RCONST(865) = (VOCuptk1stOrd(SR_MW(ind_LVOC),1.0_dp,State_Het))
  RCONST(866) = (VOCuptk1stOrd(SR_MW(ind_MVKN),5.0E-3_dp,State_Het))
  RCONST(867) = (VOCuptk1stOrd(SR_MW(ind_R4N2),5.0E-3_dp,State_Het))
  RCONST(868) = (VOCuptk1stOrd(SR_MW(ind_MONITS),1.0E-2_dp,State_Het))
  RCONST(869) = (VOCuptk1stOrd(SR_MW(ind_MONITU),1.0E-2_dp,State_Het))
  RCONST(870) = (VOCuptk1stOrd(SR_MW(ind_HONIT),1.0E-2_dp,State_Het))
  RCONST(871) = (MGLYuptk1stOrd(SR_MW(ind_PYAC),State_Het))
  RCONST(872) = (IEPOXuptk1stOrd(SR_MW(ind_HMML),.TRUE.,State_Het))
  RCONST(873) = (VOCuptk1stOrd(SR_MW(ind_IHN1),5.0E-3_dp,State_Het))
  RCONST(874) = (VOCuptk1stOrd(SR_MW(ind_IHN2),5.0E-2_dp,State_Het))
  RCONST(875) = (VOCuptk1stOrd(SR_MW(ind_IHN3),5.0E-3_dp,State_Het))
  RCONST(876) = (VOCuptk1stOrd(SR_MW(ind_IHN4),5.0E-3_dp,State_Het))
  RCONST(877) = (IEPOXuptk1stOrd(SR_MW(ind_ICHE),.FALSE.,State_Het))
  RCONST(878) = (VOCuptk1stOrd(SR_MW(ind_INPD),5.0E-3_dp,State_Het))
  RCONST(879) = (VOCuptk1stOrd(SR_MW(ind_INPB),5.0E-3_dp,State_Het))
  RCONST(880) = (VOCuptk1stOrd(SR_MW(ind_IDN),5.0E-3_dp,State_Het))
  RCONST(881) = (VOCuptk1stOrd(SR_MW(ind_ITCN),5.0E-3_dp,State_Het))
  RCONST(882) = (VOCuptk1stOrd(SR_MW(ind_ITHN),5.0E-3_dp,State_Het))
  RCONST(883) = (VOCuptk1stOrd(SR_MW(ind_MCRHNB),5.0E-3_dp,State_Het))
  RCONST(884) = (VOCuptk1stOrd(SR_MW(ind_MCRHN),5.0E-3_dp,State_Het))
  RCONST(885) = (VOCuptk1stOrd(SR_MW(ind_NPHEN),1.0E-2_dp,State_Het))
  RCONST(886) = (PHOTOL(2))
  RCONST(887) = (PHOTOL(3))
  RCONST(888) = (PHOTOL(1))
  RCONST(889) = (PHOTOL(11))
  RCONST(890) = (PHOTOL(9))
  RCONST(891) = (PHOTOL(10))
  RCONST(892) = (PHOTOL(7))
  RCONST(893) = (PHOTOL(8))
  RCONST(894) = (PHOTOL(16))
  RCONST(895) = (PHOTOL(15))
  RCONST(896) = (PHOTOL(17))
  RCONST(897) = (PHOTOL(18))
  RCONST(898) = (PHOTOL(12))
  RCONST(899) = (PHOTOL(13))
  RCONST(900) = (PHOTOL(14))
  RCONST(901) = (PHOTOL(61))
  RCONST(902) = (PHOTOL(62))
  RCONST(903) = (PHOTOL(59))
  RCONST(904) = (PHOTOL(59))
  RCONST(905) = (PHOTOL(66))
  RCONST(906) = (PHOTOL(70))
  RCONST(907) = (PHOTOL(70))
  RCONST(908) = (PHOTOL(76))
  RCONST(909) = (PHOTOL(77))
  RCONST(910) = (PHOTOL(69))
  RCONST(911) = (PHOTOL(68))
  RCONST(912) = (PHOTOL(72))
  RCONST(913) = (PHOTOL(73))
  RCONST(914) = (PHOTOL(74))
  RCONST(915) = (PHOTOL(71))
  RCONST(916) = (PHOTOL(63))
  RCONST(917) = (PHOTOL(64))
  RCONST(918) = (PHOTOL(65))
  RCONST(919) = (PHOTOL(66))
  RCONST(920) = (PHOTOL(75))
  RCONST(921) = (PHOTOL(79))
  RCONST(922) = (PHOTOL(80))
  RCONST(923) = (PHOTOL(81))
  RCONST(924) = (PHOTOL(82))
  RCONST(925) = (PHOTOL(83))
  RCONST(926) = (PHOTOL(83))
  RCONST(927) = (PHOTOL(83))
  RCONST(928) = (PHOTOL(84))
  RCONST(929) = (PHOTOL(85))
  RCONST(930) = (PHOTOL(98))
  RCONST(931) = (PHOTOL(98))
  RCONST(932) = (PHOTOL(98))
  RCONST(933) = (PHOTOL(98))
  RCONST(934) = (PHOTOL(99))
  RCONST(935) = (PHOTOL(23))
  RCONST(936) = (PHOTOL(28))
  RCONST(937) = (PHOTOL(32))
  RCONST(938) = (PHOTOL(29))
  RCONST(939) = (PHOTOL(30))
  RCONST(940) = (PHOTOL(31))
  RCONST(941) = (PHOTOL(56))
  RCONST(942) = (PHOTOL(55))
  RCONST(943) = (PHOTOL(50))
  RCONST(944) = (PHOTOL(43))
  RCONST(945) = (PHOTOL(45))
  RCONST(946) = (PHOTOL(33))
  RCONST(947) = (PHOTOL(22))
  RCONST(948) = (PHOTOL(27))
  RCONST(949) = (PHOTOL(25))
  RCONST(950) = (PHOTOL(26))
  RCONST(951) = (PHOTOL(21))
  RCONST(952) = (PHOTOL(19))
  RCONST(953) = (PHOTOL(20))
  RCONST(954) = (PHOTOL(24))
  RCONST(955) = (PHOTOL(44))
  RCONST(956) = (PHOTOL(42))
  RCONST(957) = (PHOTOL(37))
  RCONST(958) = (PHOTOL(38))
  RCONST(959) = (PHOTOL(39))
  RCONST(960) = (PHOTOL(40))
  RCONST(961) = (PHOTOL(41))
  RCONST(962) = (PHOTOL(47))
  RCONST(963) = (PHOTOL(48))
  RCONST(964) = (PHOTOL(49))
  RCONST(965) = (PHOTOL(46))
  RCONST(966) = (PHOTOL(53))
  RCONST(967) = (PHOTOL(51))
  RCONST(968) = (PHOTOL(54))
  RCONST(969) = (PHOTOL(101))
  RCONST(970) = (PHOTOL(114))
  RCONST(971) = (PHOTOL(115))
  RCONST(972) = (PHOTOL(116))
  RCONST(973) = (PHOTOL(117))
  RCONST(974) = (PHOTOL(118))
  RCONST(975) = (PHOTOL(119))
  RCONST(976) = (PHOTOL(120))
  RCONST(977) = (PHOTOL(121))
  RCONST(978) = (PHOTOL(122))
  RCONST(979) = (PHOTOL(123))
  RCONST(980) = (PHOTOL(124))
  RCONST(981) = (PHOTOL(125))
  RCONST(982) = (PHOTOL(126))
  RCONST(983) = (PHOTOL(127))
  RCONST(984) = (PHOTOL(128))
  RCONST(985) = (PHOTOL(129))
  RCONST(986) = (PHOTOL(103))
  RCONST(987) = (PHOTOL(104))
  RCONST(988) = (PHOTOL(97))
  RCONST(989) = (PHOTOL(36))
  RCONST(990) = (PHOTOL(34))
  RCONST(991) = (PHOTOL(100))
  RCONST(992) = (PHOTOL(6))
  RCONST(993) = (PHOTOL(105))
  RCONST(994) = (PHOTOL(107))
  RCONST(995) = (PHOTOL(111))
  RCONST(996) = (PHOTOL(112))
  RCONST(997) = (PHOTOL(113))
  RCONST(998) = (PHOTOL(130))
  RCONST(999) = (PHOTOL(131))
  RCONST(1000) = (PHOTOL(132))
  RCONST(1001) = (PHOTOL(133))
  RCONST(1002) = (PHOTOL(134))
  RCONST(1003) = (PHOTOL(135))
  RCONST(1004) = (PHOTOL(136))
  RCONST(1005) = (PHOTOL(137))
  RCONST(1006) = (PHOTOL(86))
  RCONST(1007) = (PHOTOL(87))
  RCONST(1008) = (PHOTOL(88))
  RCONST(1009) = (PHOTOL(89))
  RCONST(1010) = (PHOTOL(90))
  RCONST(1011) = (PHOTOL(91))
  RCONST(1012) = (PHOTOL(92))
  RCONST(1013) = (PHOTOL(93))
  RCONST(1014) = (PHOTOL(94))
  RCONST(1015) = (PHOTOL(95))
  RCONST(1016) = (PHOTOL(96))
  RCONST(1017) = (PHOTOL(108))
  RCONST(1018) = (PHOTOL(109))
  RCONST(1019) = (PHOTOL(110))
  RCONST(1020) = (PHOTOL(138))
  RCONST(1021) = (PHOTOL(139))
  RCONST(1022) = (PHOTOL(140))
  RCONST(1023) = (PHOTOL(141))
  RCONST(1024) = (PHOTOL(142))
  RCONST(1025) = (PHOTOL(143))
  RCONST(1026) = (PHOTOL(144))
  RCONST(1027) = (PHOTOL(145))
  RCONST(1028) = (PHOTOL(146))
  RCONST(1029) = (PHOTOL(147))
  RCONST(1030) = (PHOTOL(148))
  RCONST(1031) = (PHOTOL(149))
  RCONST(1032) = (PHOTOL(150))
  RCONST(1033) = (PHOTOL(151))
  RCONST(1034) = (PHOTOL(152))
  RCONST(1035) = (PHOTOL(106))
  RCONST(1036) = (PHOTOL(78))
  RCONST(1037) = (PHOTOL(153))
  RCONST(1038) = (PHOTOL(154))
  RCONST(1039) = (PHOTOL(155))
  RCONST(1040) = (PHOTOL(156))
  RCONST(1041) = (PHOTOL(157))
  RCONST(1042) = (PHOTOL(158))
  RCONST(1043) = (PHOTOL(159))
  RCONST(1044) = (PHOTOL(160))
  RCONST(1045) = (PHOTOL(161))
  RCONST(1046) = (PHOTOL(162))
  RCONST(1047) = (PHOTOL(163))
  RCONST(1048) = (PHOTOL(164))
  RCONST(1049) = (PHOTOL(165))
  RCONST(1050) = (PHOTOL(166))
  RCONST(1051) = (PHOTOL(167))
  RCONST(1052) = (PHOTOL(168))
  RCONST(1053) = (PHOTOL(169))
  RCONST(1054) = (PHOTOL(170))
  RCONST(1055) = (PHOTOL(171))
  RCONST(1056) = (PHOTOL(172))
  RCONST(1057) = (PHOTOL(173))
  RCONST(1058) = (PHOTOL(174))
  RCONST(1059) = (PHOTOL(175))
  RCONST(1060) = (PHOTOL(176))
  RCONST(1061) = (PHOTOL(105))
  RCONST(1062) = (PHOTOL(177))
