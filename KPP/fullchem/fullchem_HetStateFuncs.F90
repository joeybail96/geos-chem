...
! !DEFINED PARAMETERS:
  ...
  INTEGER,  PRIVATE, PARAMETER :: PLYADU1        = 15 ! Playa dust 
  INTEGER,  PRIVATE, PARAMETER :: PLYADU2        = 16 ! Playa dust 
  INTEGER,  PRIVATE, PARAMETER :: PLYADU3        = 17 ! Playa dust 
  INTEGER,  PRIVATE, PARAMETER :: PLYADU4        = 18 ! Playa dust 
!
