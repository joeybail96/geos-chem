...
MODULE gckpp_Monitor
  ...
  CHARACTER(LEN=32), PARAMETER, DIMENSION(90) :: SPC_NAMES_0 = (/ &
     ...
     'PLYACL1                         ','PLYACL2                         ','PLYACL3                         ', & ! index 46 - 48
     'PLYACL4                         ','CCl4                            ','CFC11                           ', & ! index 49 - 51
  ...
  CHARACTER(LEN=32), PARAMETER, DIMENSION(90) :: SPC_NAMES_1 = (/ &
     ...
     'ALK4P                           ','IONITA                          ','ICl                             ', & ! index 106 - 108
     'CH3Br                           ','ClOO                            ','HMML                            ', & ! index 109 - 111
     'HNO4                            ','C2H4                            ','APINP                           ', & ! index 112 - 114
     'BPINP                           ','MEKPN                           ','PHAN                            ', & ! index 115 - 117
     'PYAC                            ','RNO3                            ','ETO                             ', & ! index 118 - 120
     'BENZP                           ','ETP                             ','IDC                             ', & ! index 121 - 123
     'OClO                            ','TLFUO2                          ','AROMPN                          ', & ! index 124 - 126
     'PP                              ','PPN                             ','PRPN                            ', & ! index 127 - 129
     'APAN                            ','BUTN                            ','IEPOXD                          ', & ! index 130 - 132
     'ACRO2                           ','BPINO                           ','LIMO2H                          ', & ! index 133 - 135
     'MVKDH                           ','HPALD2OO                        ','HPALD1OO                        ', & ! index 136 - 138
     'SO4                             ','ETHP                            ','APINN                           ', & ! index 139 - 141
     'BPINN                           ','PAN                             ','C3H8                            ', & ! index 142 - 144
     'C4H6                            ','ALK4                            ','BENZ                            ', & ! index 145 - 147
     ...
     'LIMO3H                          ','IHN2                            ','IDHDP                           ', & ! index 172 - 174
     'C4HVP1                          ','C4HVP2                          ','IHN3                            ', & ! index 175 - 177
  ...
  CHARACTER(LEN=32), PARAMETER, DIMENSION(90) :: SPC_NAMES_2 = (/ &
     ...
     'ISOPNOO2                        ','INPD                            ','C2H6                            ', & ! index 187 - 189
     ...
     'BALD                            ','IDHNDOO1                        ','IDHNDOO2                        ', & ! index 208 - 210
     'ISOPNOO1                        ','MVKHC                           ','LIMN                            ', & ! index 211 - 213
     'RIPC                            ','HPETHNL                         ','BUTO2                           ', & ! index 214 - 216
     'ICHE                            ','N2O5                            ','GCO3                            ', & ! index 217 - 219
     'MCRHNB                          ','H                               ','BrNO3                           ', & ! index 220 - 222
     'MTPO                            ','STYR                            ','AROMP4                          ', & ! index 223 - 225
     'INPB                            ','PINAL                           ','IHPOO1                          ', & ! index 226 - 228
     'IHPOO2                          ','IHPNDOO                         ','ACR                             ', & ! index 229 - 231
     'MVKHCB                          ','HPALD1                          ','CH4                             ', & ! index 232 - 234
     'PIP                             ','HPALD2                          ','IHPOO3                          ', & ! index 235 - 237
     ...
     'R4N2                            ','MCROHOO                         ','LIMAL                           ', & ! index 256 - 258
     'MVKOHOO                         ','ICPDH                           ','MONITS                          ', & ! index 259 - 261
     'PINO3                           ','MACR1OO                         ','ETHLN                           ', & ! index 262 - 264
     'PO2                             ','MYRCO                           ','AROMRO2                         ', & ! index 265 - 267
  ...
  CHARACTER(LEN=32), PARAMETER, DIMENSION(90) :: SPC_NAMES_3 = (/ &
     ...
     'ISOP                            ','LIMO2                           ','APINO2                          ', & ! index 280 - 282
     'C96O2                           ','ALK4N2                          ','MOH                             ', & ! index 283 - 285
     'ACTA                            ','OLNN                            ','IO                              ', & ! index 286 - 288
     'IEPOXAOO                        ','IEPOXBOO                        ','MVKHP                           ', & ! index 289 - 291
     'MCRHP                           ','OLND                            ','PRPE                            ', & ! index 292 - 294
     ...
     'HOCl                            ','O1D                             ','O                               ', & ! index 337 - 339
     'SO2                             ','OH                              ','NO                              ', & ! index 340 - 342
     'NO2                             ','O3                              ','ClO                             ', & ! index 343 - 345
     'Br                              ','HO2                             ','SALCCL                          ', & ! index 346 - 348
     'HCl                             ','H2O                             ','BrO                             ', & ! index 349 - 351
     'HBr                             ','BrSALA                          ','BrSALC                          ', & ! index 352 - 354
     'NO3                             ','SALACL                          ','Cl                              ', & ! index 355 - 357
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_8 = (/ &
     ...
     '        O1D + HCl --> 0.66 LOx + 0.22 H + 0.12 O + 0.66 OH + 0.22 ClO + 0.12 HCl + 0.66 Cl          ', & ! index 253
     '        O1D + HBr --> 0.6 LOx + 0.2 H + 0.2 O + 0.6 OH + 0.6 Br + 0.2 BrO + 0.2 HBr                 ', & ! index 254
     ...
     '      H1211 + O1D --> 0.35 H1211 + 0.35 O + 0.34 ClO + 0.34 Br + 0.31 BrO + 0.31 Cl                 ', & ! index 264
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_17 = (/ &
     '    IHOO1 + IHOO4 --> PCO + HC5A + 0.5 MVKHP + 0.5 MCRHP + CO + OH + HO2                            ', & ! index 511
     ...
     '        HC5A + OH --> 0.355 CO2 + 0.638 PCO + 0.294 IEPOXAOO + 0.068 IEPOXBOO + 0.125 MVKHP ... etc.', & ! index 528
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_26 = (/ &
     ...
     '   PLYACL1 + N2O5 --> LOx + ClNO2 + HNO3                                                            ', & ! index 791
     '   PLYACL2 + N2O5 --> LOx + ClNO2 + HNO3                                                            ', & ! index 792
     '   PLYACL3 + N2O5 --> LOx + ClNO2 + HNO3                                                            ', & ! index 793
     '   PLYACL4 + N2O5 --> LOx + ClNO2 + HNO3                                                            ', & ! index 794
     '      OH + SALACL --> 0.5 Cl2                                                                       ', & ! index 795
     '      OH + SALCCL --> 0.5 Cl2                                                                       ', & ! index 796
     '      BrNO3 + H2O --> HOBr + HNO3                                                                   ', & ! index 797
     '      BrNO3 + HCl --> LOx + BrCl + HNO3                                                             ', & ! index 798
     '      ClNO3 + H2O --> HNO3 + HOCl                                                                   ', & ! index 799
     '      ClNO3 + HCl --> LOx + Cl2 + HNO3                                                              ', & ! index 800
     '      ClNO3 + HBr --> LOx + BrCl + HNO3                                                             ', & ! index 801
     '   ClNO3 + BrSALA --> LOx + BrCl + HNO3                                                             ', & ! index 802
     '   ClNO3 + BrSALC --> LOx + BrCl + HNO3                                                             ', & ! index 803
     '   ClNO3 + SALACL --> LOx + Cl2 + HNO3                                                              ', & ! index 804
     '   ClNO3 + SALCCL --> LOx + Cl2 + HNO3                                                              ', & ! index 805
     '   ClNO2 + SALACL --> LOx + HNO2 + Cl2                                                              ', & ! index 806
     '   ClNO2 + SALCCL --> LOx + HNO2 + Cl2                                                              ', & ! index 807
     '      ClNO2 + HCl --> LOx + HNO2 + Cl2                                                              ', & ! index 808
     '   ClNO2 + BrSALA --> LOx + BrCl + HNO2                                                             ', & ! index 809
     '   ClNO2 + BrSALC --> LOx + BrCl + HNO2                                                             ' /) ! index up to 810
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_27 = (/ &
     '      ClNO2 + HBr --> LOx + BrCl + HNO2                                                             ', & ! index 811
     '       HOCl + HCl --> LOx + Cl2 + H2O                                                               ', & ! index 812
     '       HOCl + HBr --> LOx + BrCl + H2O                                                              ', & ! index 813
     '    HOCl + SALACL --> LOx + Cl2 + H2O                                                               ', & ! index 814
     '    HOCl + SALCCL --> LOx + Cl2 + H2O                                                               ', & ! index 815
     '       HOCl + SO2 --> LOx + PSO4 + SO4 + HCl                                                        ', & ! index 816
     '       HOBr + HBr --> LOx + Br2 + H2O                                                               ', & ! index 817
     '       HOBr + HCl --> LOx + BrCl + H2O                                                              ', & ! index 818
     '    HOBr + SALACL --> LOx + BrCl + H2O                                                              ', & ! index 819
     '    HOBr + SALCCL --> LOx + BrCl + H2O                                                              ', & ! index 820
     '    HOBr + BrSALA --> LOx + Br2                                                                     ', & ! index 821
     '    HOBr + BrSALC --> LOx + Br2                                                                     ', & ! index 822
     '       HOBr + SO2 --> LOx + PSO4 + SO4 + HBr                                                        ', & ! index 823
     '         O3 + HBr --> HOBr                                                                          ', & ! index 824
     '      O3 + BrSALA --> HOBr                                                                          ', & ! index 825
     '      O3 + BrSALC --> HOBr                                                                          ', & ! index 826
     '              HBr --> BrSALA                                                                        ', & ! index 827
     '              HBr --> BrSALC                                                                        ', & ! index 828
     '               HI --> AERI                                                                          ', & ! index 829
     '               HI --> ISALA                                                                         ', & ! index 830
     '               HI --> ISALC                                                                         ', & ! index 831
     '              HOI --> ISALA + LOx                                                                   ', & ! index 832
     '              HOI --> ISALC + LOx                                                                   ', & ! index 833
     '             I2O2 --> 2 AERI + 2 LOx                                                                ', & ! index 834
     '             I2O2 --> 2 ISALA + 2 LOx                                                               ', & ! index 835
     '             I2O2 --> 2 ISALC + 2 LOx                                                               ', & ! index 836
     '             I2O3 --> 2 AERI + 3 LOx                                                                ', & ! index 837
     '             I2O3 --> 2 ISALA + 3 LOx                                                               ', & ! index 838
     '             I2O3 --> 2 ISALC + 3 LOx                                                               ', & ! index 839
     '             I2O4 --> 2 AERI + 4 LOx                                                                ' /) ! index up to 840
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_28 = (/ &
     '             I2O4 --> 2 ISALA + 4 LOx                                                               ', & ! index 841
     '             I2O4 --> 2 ISALC + 4 LOx                                                               ', & ! index 842
     '             IONO --> ISALA + LOx + HNO2                                                            ', & ! index 843
     '             IONO --> ISALC + LOx + HNO2                                                            ', & ! index 844
     '            IONO2 --> ISALA + LOx + HNO3                                                            ', & ! index 845
     '            IONO2 --> ISALC + LOx + HNO3                                                            ', & ! index 846
     '      IONO2 + H2O --> HNO3 + HOI                                                                    ', & ! index 847
     '    IONO + BrSALA --> LOx + IBr + HNO2                                                              ', & ! index 848
     '    IONO + BrSALC --> LOx + IBr + HNO2                                                              ', & ! index 849
     '    IONO + SALACL --> LOx + ICl + HNO2                                                              ', & ! index 850
     '    IONO + SALCCL --> LOx + ICl + HNO2                                                              ', & ! index 851
     '   IONO2 + BrSALA --> LOx + IBr + HNO3                                                              ', & ! index 852
     '   IONO2 + BrSALC --> LOx + IBr + HNO3                                                              ', & ! index 853
     '   IONO2 + SALACL --> LOx + ICl + HNO3                                                              ', & ! index 854
     '   IONO2 + SALCCL --> LOx + ICl + HNO3                                                              ', & ! index 855
     '     HOI + BrSALA --> LOx + IBr                                                                     ', & ! index 856
     '     HOI + BrSALC --> LOx + IBr                                                                     ', & ! index 857
     '     HOI + SALACL --> LOx + ICl                                                                     ', & ! index 858
     '     HOI + SALCCL --> LOx + ICl                                                                     ', & ! index 859
     '             GLYX --> SOAGX                                                                         ', & ! index 860
     '             MGLY --> 1.5 SOAGX                                                                     ', & ! index 861
     '           IEPOXA --> SOAIE                                                                         ', & ! index 862
     '           IEPOXB --> SOAIE                                                                         ', & ! index 863
     '           IEPOXD --> SOAIE                                                                         ', & ! index 864
     '             LVOC --> LVOCOA                                                                        ', & ! index 865
     '             MVKN --> LOx + IONITA                                                                  ', & ! index 866
     '             R4N2 --> LOx + IONITA                                                                  ', & ! index 867
     '           MONITS --> LOx + MONITA                                                                  ', & ! index 868
     '           MONITU --> LOx + MONITA                                                                  ', & ! index 869
     '            HONIT --> LOx + MONITA                                                                  ' /) ! index up to 870
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_29 = (/ &
     '             PYAC --> 1.5 SOAGX                                                                     ', & ! index 871
     '             HMML --> 0.8 SOAIE                                                                     ', & ! index 872
     '             IHN1 --> LOx + IONITA                                                                  ', & ! index 873
     '             IHN2 --> LOx + IONITA                                                                  ', & ! index 874
     '             IHN3 --> LOx + IONITA                                                                  ', & ! index 875
     '             IHN4 --> LOx + IONITA                                                                  ', & ! index 876
     '             ICHE --> SOAIE                                                                         ', & ! index 877
     '             INPD --> LOx + IONITA                                                                  ', & ! index 878
     '             INPB --> LOx + IONITA                                                                  ', & ! index 879
     '              IDN --> 2 LOx + IONITA                                                                ', & ! index 880
     '             ITCN --> LOx + IONITA                                                                  ', & ! index 881
     '             ITHN --> LOx + IONITA                                                                  ', & ! index 882
     '           MCRHNB --> LOx + IONITA                                                                  ', & ! index 883
     '            MCRHN --> LOx + IONITA                                                                  ', & ! index 884
     '            NPHEN --> AONITA                                                                        ', & ! index 885
     '               O3 --> O + O2                                                                        ', & ! index 886
     '               O3 --> O1D + O2                                                                      ', & ! index 887
     '               O2 --> 2 POx + 2 O                                                                   ', & ! index 888
     '              NO2 --> O + NO                                                                        ', & ! index 889
     '             H2O2 --> 2 OH                                                                          ', & ! index 890
     '               MP --> CH2O + OH + HO2                                                               ', & ! index 891
     '             CH2O --> PCO + H + CO + HO2                                                            ', & ! index 892
     '             CH2O --> PCO + CO + H2                                                                 ', & ! index 893
     '             HNO3 --> OH + NO2                                                                      ', & ! index 894
     '             HNO2 --> OH + NO                                                                       ', & ! index 895
     '             HNO4 --> POx + OH + NO3                                                                ', & ! index 896
     '             HNO4 --> NO2 + HO2                                                                     ', & ! index 897
     '              NO3 --> O + NO2                                                                       ', & ! index 898
     '              NO3 --> 2 LOx + NO + O2                                                               ', & ! index 899
     '             N2O5 --> NO2 + NO3                                                                     ' /) ! index up to 900
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_30 = (/ &
     '             ALD2 --> 0.88 PCO + 0.12 MCO3 + 0.88 MO2 + 0.88 CO + HO2                               ', & ! index 901
     '             ALD2 --> PCO + CH4 + CO                                                                ', & ! index 902
     '              PAN --> 0.3 CO2 + 0.3 POx + 0.7 MCO3 + 0.3 MO2 + 0.7 NO2 + 0.3 NO3                    ', & ! index 903
     '             APAN --> POx + ACO3 + NO2                                                              ', & ! index 904
     '              ACR --> 0.7 PCO + 0.4 C2H4 + 0.3 ACO3 + 0.3 CH2O + 0.7 CO + 0.3 HO2                   ', & ! index 905
     '          AROMCHO --> PCO + MCO3 + CH2O + CO + HO2                                                  ', & ! index 906
     '             RCHO --> PCO + 0.49 OTHRO2 + 0.07 A3O2 + 0.27 B3O2 + CO + HO2                          ', & ! index 907
     '             ACET --> MCO3 + MO2                                                                    ', & ! index 908
     '             ACET --> PCO + 2 MO2 + CO                                                              ', & ! index 909
     '              MEK --> 0.415 OTHRO2 + 0.15 RCO3 + 0.06 A3O2 + 0.23 B3O2 + 0.85 MCO3 + 0.15 MO2       ', & ! index 910
     '             GLYC --> PCO + 0.1 MOH + 0.9 CH2O + CO + 0.07 OH + 1.73 HO2                            ', & ! index 911
     '             GLYX --> 2 PCO + 2 CO + 2 HO2                                                          ', & ! index 912
     '             GLYX --> 2 PCO + 2 CO + H2                                                             ', & ! index 913
     '             GLYX --> PCO + CH2O + CO                                                               ', & ! index 914
     '             MGLY --> PCO + MCO3 + CO + HO2                                                         ', & ! index 915
     '              MVK --> PCO + PRPE + CO                                                               ', & ! index 916
     '              MVK --> PCO + MCO3 + CH2O + CO + HO2                                                  ', & ! index 917
     '              MVK --> RCO3 + MO2                                                                    ', & ! index 918
     '             MACR --> PCO + MCO3 + CH2O + CO + HO2                                                  ', & ! index 919
     '              HAC --> MCO3 + CH2O + HO2                                                             ', & ! index 920
     '             PRPN --> RCHO + OH + NO2 + HO2                                                         ', & ! index 921
     '              ETP --> ALD2 + OH + HO2                                                               ', & ! index 922
     '             RA3P --> RCHO + OH + HO2                                                               ', & ! index 923
     '             RB3P --> ACET + OH + HO2                                                               ', & ! index 924
     '              R4P --> 1.5 RCHO + OH + HO2                                                           ', & ! index 925
     '              R7P --> RCHO + OH + HO2                                                               ', & ! index 926
     '            ALK4P --> 1.5 RCHO + OH + HO2                                                           ', & ! index 927
     '               PP --> CH2O + ALD2 + OH + HO2                                                        ', & ! index 928
     '               RP --> ALD2 + MO2 + OH + HO2                                                         ', & ! index 929
     '             R4N2 --> 0.19 MEK + 0.34 ACET + 0.15 RCHO + 0.34 OTHRO2 + 0.05 A3O2 + 0.19 B3O2... etc.' /) ! index up to 930
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_31 = (/ &
     '             R7N2 --> POx + 1.558 RCHO + 0.326 RCO3 + 0.326 MCO3 + 0.348 ALD2 + NO2 + 0.326 HO2     ', & ! index 931
     '             RNO3 --> POx + BALD + NO2 + HO2 + H2O                                                  ', & ! index 932
     '           ALK4N2 --> 0.19 MEK + 0.34 ACET + 0.15 RCHO + 0.34 OTHRO2 + 0.05 A3O2 + 0.19 B3O2... etc.', & ! index 933
     '              MAP --> CO2 + MO2 + OH                                                                ', & ! index 934
     '              Br2 --> 2 Br                                                                          ', & ! index 935
     '              BrO --> O + Br                                                                        ', & ! index 936
     '             HOBr --> LOx + OH + Br                                                                 ', & ! index 937
     '            BrNO3 --> Br + NO3                                                                      ', & ! index 938
     '            BrNO3 --> NO2 + BrO                                                                     ', & ! index 939
     '            BrNO2 --> NO2 + Br                                                                      ', & ! index 940
     '            CHBr3 --> 3 Br                                                                          ', & ! index 941
     '           CH2Br2 --> 2 Br                                                                          ', & ! index 942
     '            CH3Br --> MO2 + Br                                                                      ', & ! index 943
     '            CH3Cl --> MO2 + Cl                                                                      ', & ! index 944
     '           CH2Cl2 --> 2 Cl                                                                          ', & ! index 945
     '             BrCl --> Br + Cl                                                                       ', & ! index 946
     '              Cl2 --> 2 Cl                                                                          ', & ! index 947
     '              ClO --> O + Cl                                                                        ', & ! index 948
     '             OClO --> O + ClO                                                                       ', & ! index 949
     '            Cl2O2 --> 2 LOx + ClOO + Cl                                                             ', & ! index 950
     '            ClNO2 --> NO2 + Cl                                                                      ', & ! index 951
     '            ClNO3 --> NO3 + Cl                                                                      ', & ! index 952
     '            ClNO3 --> NO2 + ClO                                                                     ', & ! index 953
     '             HOCl --> LOx + OH + Cl                                                                 ', & ! index 954
     '          CH3CCl3 --> 3 Cl                                                                          ', & ! index 955
     '             CCl4 --> 4 Cl                                                                          ', & ! index 956
     '            CFC11 --> 3 Cl                                                                          ', & ! index 957
     '            CFC12 --> 2 Cl                                                                          ', & ! index 958
     '           CFC113 --> 3 Cl                                                                          ', & ! index 959
     '           CFC114 --> 2 Cl                                                                          ' /) ! index up to 960
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_32 = (/ &
     '           CFC115 --> Cl                                                                            ', & ! index 961
     '          HCFC123 --> 2 Cl                                                                          ', & ! index 962
     '         HCFC141b --> 2 Cl                                                                          ', & ! index 963
     '         HCFC142b --> Cl                                                                            ', & ! index 964
     '           HCFC22 --> Cl                                                                            ', & ! index 965
     '            H1301 --> Br                                                                            ', & ! index 966
     '            H1211 --> Br + Cl                                                                       ', & ! index 967
     '            H2402 --> 2 Br                                                                          ', & ! index 968
     '             ClOO --> Cl + O2                                                                       ', & ! index 969
     '               I2 --> 2 I                                                                           ', & ! index 970
     '              HOI --> LOx + I + OH                                                                  ', & ! index 971
     '               IO --> I + O                                                                         ', & ! index 972
     '              OIO --> 2 LOx + I + O2                                                                ', & ! index 973
     '              INO --> I + NO                                                                        ', & ! index 974
     '             IONO --> I + NO2                                                                       ', & ! index 975
     '            IONO2 --> I + NO3                                                                       ', & ! index 976
     '             I2O2 --> OIO + I                                                                       ', & ! index 977
     '             CH3I --> I                                                                             ', & ! index 978
     '            CH2I2 --> 2 I                                                                           ', & ! index 979
     '           CH2ICl --> I + Cl                                                                        ', & ! index 980
     '           CH2IBr --> I + Br                                                                        ', & ! index 981
     '             I2O4 --> 2 OIO                                                                         ', & ! index 982
     '             I2O3 --> OIO + IO                                                                      ', & ! index 983
     '              IBr --> I + Br                                                                        ', & ! index 984
     '              ICl --> I + Cl                                                                        ', & ! index 985
     '              MPN --> POx + CH2O + HO2 + NO3                                                        ', & ! index 986
     '              MPN --> MO2 + NO2                                                                     ', & ! index 987
     '            ATOOH --> MCO3 + CH2O + OH                                                              ', & ! index 988
     '              N2O --> POx + O1D + N2                                                                ', & ! index 989
     '              OCS --> PCO + CO + SO2                                                                ' /) ! index up to 990
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_33 = (/ &
     '              SO4 --> SO2 + 2 OH                                                                    ', & ! index 991
     '               NO --> POx + N + O                                                                   ', & ! index 992
     '              PIP --> RCHO + OH + HO2                                                               ', & ! index 993
     '            ETHLN --> PCO + CH2O + CO + NO2 + HO2                                                   ', & ! index 994
     '           MONITS --> MEK + NO2                                                                     ', & ! index 995
     '           MONITU --> RCHO + NO2                                                                    ', & ! index 996
     '            HONIT --> HAC + NO2                                                                     ', & ! index 997
     '             NITs --> LOx + HNO2                                                                    ', & ! index 998
     '             NITs --> NO2                                                                           ', & ! index 999
     '              NIT --> LOx + HNO2                                                                    ', & ! index 1000
     '              NIT --> NO2                                                                           ', & ! index 1001
     '            MENO3 --> POx + CH2O + NO2 + HO2                                                        ', & ! index 1002
     '            ETNO3 --> POx + ALD2 + NO2 + HO2                                                        ', & ! index 1003
     '           IPRNO3 --> POx + ACET + NO2 + HO2                                                        ', & ! index 1004
     '           NPRNO3 --> POx + RCHO + NO2 + HO2                                                        ', & ! index 1005
     '             HMHP --> CH2O + 2 OH                                                                   ', & ! index 1006
     '          HPETHNL --> PCO + CH2O + CO + OH + HO2                                                    ', & ! index 1007
     '             PYAC --> CO2 + MCO3 + HO2                                                              ', & ! index 1008
     '           PROPNN --> MCO3 + CH2O + NO2                                                             ', & ! index 1009
     '            MVKHC --> PCO + MCO3 + CH2O + CO + HO2                                                  ', & ! index 1010
     '           MVKHCB --> 0.5 PCO + 0.5 GLYX + 0.5 MGLY + 0.5 MCO3 + 0.5 CO + 1.5 HO2                   ', & ! index 1011
     '            MVKHP --> 0.47 MGLY + 0.53 GLYC + 0.53 MCO3 + 0.47 CH2O + OH + 0.47 HO2                 ', & ! index 1012
     '            MVKPC --> 0.571 PCO + 0.429 GLYX + 0.571 MGLY + 0.429 MCO3 + 0.571 CO + OH + 0.571 HO2  ', & ! index 1013
     '          MCRENOL --> 0.875 PCO + 0.75 PYAC + 0.125 GLYX + 0.125 MGLY + 0.125 MCO3 + 0.875 C... etc.', & ! index 1014
     '            MCRHP --> 0.77 PCO + 0.23 MGLY + 0.77 HAC + 0.23 CH2O + 0.77 CO + OH + HO2              ', & ! index 1015
     '         MACR1OOH --> 1.238 CO2 + 0.25 MACR1OOH + 0.262 MCO3 + 0.75 CH2O + 0.488 MO2 + 0.75 OH      ', & ! index 1016
     '             MVKN --> 0.3 ETHLN + 0.69 GLYC + 1.01 MCO3 + 0.01 OH + 0.7 NO2 + 0.29 HO2              ', & ! index 1017
     '            MCRHN --> PCO + HAC + CO + NO2 + HO2                                                    ', & ! index 1018
     '           MCRHNB --> PCO + PROPNN + CO + OH + HO2                                                  ', & ! index 1019
     '             RIPA --> MVK + CH2O + OH + HO2                                                         ' /) ! index up to 1020
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_34 = (/ &
     '             RIPB --> MACR + CH2O + OH + HO2                                                        ', & ! index 1021
     '             RIPC --> HC5A + OH + HO2                                                               ', & ! index 1022
     '             RIPD --> HC5A + OH + HO2                                                               ', & ! index 1023
     '           HPALD1 --> 0.888 PCO + 0.112 IDC + 0.224 C4HVP1 + 0.112 MVKPC + 0.552 MCRENOL + 0... etc.', & ! index 1024
     '           HPALD2 --> 0.818 PCO + 0.182 IDC + 0.182 C4HVP2 + 0.182 MVKPC + 0.454 MCRENOL + 0... etc.', & ! index 1025
     '           HPALD3 --> PCO + MVK + CO + OH + HO2                                                     ', & ! index 1026
     '           HPALD4 --> PCO + MACR + CO + OH + HO2                                                    ', & ! index 1027
     '             IHN1 --> 0.55 PCO + 0.45 HC5A + 0.55 MVKHP + 0.55 CO + 0.55 OH + NO2 + 0.45 HO2        ', & ! index 1028
     '             IHN2 --> MVK + CH2O + NO2 + HO2                                                        ', & ! index 1029
     '             IHN3 --> MACR + CH2O + NO2 + HO2                                                       ', & ! index 1030
     '             IHN4 --> 0.55 PCO + 0.45 HC5A + 0.55 MCRHP + 0.55 CO + 0.55 OH + NO2 + 0.45 HO2        ', & ! index 1031
     '             INPB --> 0.097 MACR + 0.903 MVK + CH2O + 0.67 OH + NO2 + 0.33 HO2                      ', & ! index 1032
     '             INPD --> 0.841 INA + 0.159 ICN + OH + 0.159 HO2                                        ', & ! index 1033
     '             INPD --> 0.841 IHOO1 + 0.159 IHOO4 + NO2                                               ', & ! index 1034
     '              ICN --> 0.839 PCO + 0.161 IDC + 0.068 C4HVP1 + 0.128 C4HVP2 + 0.162 MVKPC + 0.... etc.', & ! index 1035
     '              IDN --> 0.222 INA + 0.223 ICN + 0.5 GLYC + 0.5 HAC + 0.005 MACR + 0.05 MVK + 0... etc.', & ! index 1036
     '            ICPDH --> PCO + 0.35 MVKDH + 0.15 MCRDH + 0.5 MCRHP + CO + 0.5 OH + 1.5 HO2             ', & ! index 1037
     '            ICPDH --> 0.163 PCO + 0.163 MCRDH + 0.133 MVKHCB + 0.586 GLYX + 0.118 MGLY + 0.1... etc.', & ! index 1038
     '            IDHDP --> 0.75 ICPDH + 0.25 GLYC + 0.25 HAC + 1.25 OH + 0.75 HO2                        ', & ! index 1039
     '            IDHPE --> 0.571 GLYX + 0.429 MGLY + 0.429 GLYC + 0.571 HAC + OH + HO2                   ', & ! index 1040
     '            IDCHP --> PCO + 0.454 MVKPC + 0.391 MVKHC + 0.155 MVKHCB + CO + 0.546 OH + 1.454 HO2    ', & ! index 1041
     '             ITHN --> 0.5 MCRHN + 0.15 ETHLN + 0.05 MVKN + 0.3 GLYC + 0.45 HAC + 0.55 CH2O +... etc.', & ! index 1042
     '             ITHN --> 0.5 HPETHNL + 0.05 ATOOH + 0.15 MCRHP + 0.35 GLYC + 0.8 HAC + 0.15 CH2... etc.', & ! index 1043
     '             ITCN --> MGLY + GLYC + OH + NO2                                                        ', & ! index 1044
     '             ITCN --> PCO + 0.5 MVKHP + 0.5 MCRHP + CO + NO2 + HO2                                  ', & ! index 1045
     '             ETHP --> ETO + OH                                                                      ', & ! index 1046
     '             BALD --> PCO + BENZO2 + CO + HO2                                                       ', & ! index 1047
     '           BZCO3H --> CO2 + BENZO2 + OH                                                             ', & ! index 1048
     '            BENZP --> BENZO                                                                         ', & ! index 1049
     '            NPHEN --> CO2 + PCO + AROMP4 + HNO2 + CO + HO2                                          ' /) ! index up to 1050
  CHARACTER(LEN=100), PARAMETER, DIMENSION(12) :: EQN_NAMES_35 = (/ &
     '              PPN --> 0.3 POx + 0.7 RCO3 + 0.7 NO2 + 0.3 NO3                                        ', & ! index 1051
     '            APINP --> PINAL + OH + HO2                                                              ', & ! index 1052
     '            PINAL --> PCO + C96O2 + CO + HO2                                                        ', & ! index 1053
     '           PINO3H --> CO2 + C96O2 + OH                                                              ', & ! index 1054
     '          PINONIC --> CO2 + C96O2 + OH                                                              ', & ! index 1055
     '           C96O2H --> AROMRO2 + 0.5 MEK + ACET + RCO3 + CH2O + OH                                   ', & ! index 1056
     '            BPINP --> BPINO + CH2O + OH + HO2                                                       ', & ! index 1057
     '          BPINOOH --> 0.27 LIMO3 + 0.6 ACET + 0.6 RCHO + 0.6 R4O2 + OH + HO2                        ', & ! index 1058
     '           LIMO3H --> CO2 + RCHO + 0.8 R4O2 + MCO3 + 0.4 CH2O + OH                                  ', & ! index 1059
     '           LIMO2H --> CO2 + RCHO + 0.8 R4O2 + MCO3 + 0.4 CH2O + OH                                  ', & ! index 1060
     '              PIP --> 0.675 MYRCO + 0.45 ACET + 0.45 MVK + 0.1 CH2O + OH + HO2                      ', & ! index 1061
     '            LIMAL --> PCO + 0.9 LIMO3 + CO + HO2                                                    ' /) ! index up to 1062
  CHARACTER(LEN=100), PARAMETER, DIMENSION(1062) :: EQN_NAMES = (/&
